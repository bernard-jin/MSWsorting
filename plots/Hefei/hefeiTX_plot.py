...
def preprocess(items, name, xaxis, plotslocation):
...
xaxis = np.linspace(887.1, 1715.45, 195)
...
plotslocation = '/home/jzq/PycharmProjects/Br/Question-塑料分析/plots/Hefei/TXNB'
...
for file in os.listdir(files):
    ...
    name = file.split('.')[0]
    data2 = preprocess(data, name, xaxis, plotslocation)
